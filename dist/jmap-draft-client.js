(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.jmapDraft = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
'use strict';

/**
 * The _API_ module is the entry point of the library.<br />
 * It exports a single {@link Object} that is exposed as, either:
 * * A global `jmapDraft` variable when jmap-draft-client included in a web page through a `script` tag
 * * A NodeJS module when jmap-draft-client is `require`'d in a NodeJS application
 *
...
var _FilterRule = require('../models/FilterRule');

var _FilterRule2 = _interopRequireDefault(_FilterRule);
...
var Client = function () {
  ...
  _createClass(Client, [{
    ...
    /**
     * Initializes the client with a list of custom mailbox roles.<br />
     * Mailboxes having these custom roles will preserve their roles.
     *
     * @param roles {String[]} The custom roles to be added
     *
     * @return {Client} This Client instance.
     */

  }, {
    key: 'withCustomMailboxRoles',
    value: function withCustomMailboxRoles() {
      var roles = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

      roles.forEach(function (role) {
        _MailboxRole2.default[role.toLocaleUpperCase('en-US')] = new _MailboxRole2.default(role);
      });
    ...
    /**
     * Include the jmapVersion on Accept header.
     *
     * @param {boolean} include - Optional, default to true. If the jmapVersion should be included.
     *
     * @return {Client} This Client instance.
     */

  }, {
    key: 'withJmapVersionHeader',
    value: function withJmapVersionHeader() {
      var include = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;

      this.includeJmapVersionHeader = include;
     ...
     * @param drafts {Mailbox} The {@link Mailbox} with role='drafts', if already available
     *
    ...
    key: 'saveAsDraft',
    value: function saveAsDraft(message, drafts) {
      return this._createMessage(message, _MailboxRole2.default.DRAFTS, drafts);
    }
    ...
    key: 'setFilter',
    value: function setFilter(filterRules, options) {
      var filterRulesAsJson = filterRules.map(function (rule) {
        return rule instanceof _FilterRule2.default ? rule.toJSONObject() : rule;
      });

      return this._jmapRequest('setFilter', _defineProperty({
        accountId: options && options.accountId,
        ifInState: options && options.ifInState || null
      }, _FilterRule2.default.ID, filterRulesAsJson)).then(function (response) {
        if (response.updated.indexOf(_FilterRule2.default.ID) < 0) {
          throw new Error('Failed to set filter. Error: ' + (response.notUpdated[_FilterRule2.default.ID] || 'none'));
        }
      });
    }
  }, {
    ...
    value: function getFilter(options) {
      return this._jmapRequest('getFilter', options).then(function (response) {
    ...
    value: function _defaultNonAuthenticatedHeaders() {
      return {
        Accept: 'application/json; charset=UTF-8' + (this.includeJmapVersionHeader ? '; jmapVersion=draft' : ''),
...
},{"../utils/Utils":36}],4:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":35,"../utils/Utils.js":36,"./Model.js":19}],6:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":35,"../utils/Utils.js":36,"./Model.js":19}],7:[function(require,module,exports){
'use strict';
...
},{"../utils/Constants.js":34,"../utils/JSONBuilder.js":35,"../utils/Utils.js":36,"./Account.js":5,"./MailCapabilities.js":14,"./Model.js":19,"./ServerCapabilities.js":21}],8:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36,"./AuthMethod":9}],9:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36}],10:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36}],11:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36,"./Model.js":19}],12:[function(require,module,exports){
'use strict';
...
var _FilterRuleConditions = require('./filterRules/FilterRuleConditions');

var _FilterRuleConditions2 = _interopRequireDefault(_FilterRuleConditions);

var _FilterRuleActions = require('./filterRules/FilterRuleActions');

var _FilterRuleActions2 = _interopRequireDefault(_FilterRuleActions);
...
var FilterRule = function (_Model) {
  _inherits(FilterRule, _Model);
   ...
   * @see Model
   */
  function FilterRule(jmap, name) {
    _classCallCheck(this, FilterRule);

    var _this = _possibleConstructorReturn(this, (FilterRule.__proto__ || Object.getPrototypeOf(FilterRule)).call(this, jmap));

    _this.id = (0, _v2.default)();
    _this.name = name;
    _this.filterCondition = null;
    _this.filterAction = null;
    return _this;
  }
  ...
  _createClass(FilterRule, [{
    key: 'toJSONObject',
    value: function toJSONObject() {
      _Utils2.default.assertRequiredParameterIsPresent(this.filterCondition, '', 'Filter must have a condition. Use \'when\'.');
      _Utils2.default.assertRequiredParameterIsPresent(this.filterAction, '', 'Filter must have an action. Use \'then\'.');
    ...
    key: 'then',
    get: function get() {
      return (0, _FilterRuleActions2.default)(this);
    }
  }, {
    key: 'when',
    get: function get() {
      return (0, _FilterRuleConditions2.default)(this);
    }
  }], [{
    key: 'fromJSONObject',
    value: function fromJSONObject(jmap, object) {
...
},{"../utils/Utils":36,"./Model.js":19,"./filterRules/FilterRuleActions":26,"./filterRules/FilterRuleConditions":27,"uuid/v4":39}],14:[function(require,module,exports){
'use strict';
...
},{"../utils/Constants":34,"./Capabilities":10}],15:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36,"./MailboxRole.js":16,"./Model.js":19}],16:[function(require,module,exports){
'use strict';
...
var Message = function (_Model) {
  ...
  function Message(jmap, id, blobId, threadId, mailboxIds, opts) {
    ...
    _this.isForwarded = opts.isForwarded || false;
...
},{"../utils/Utils.js":36,"./Attachment.js":6,"./EMailer.js":12,"./Model.js":19}],18:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36,"./Model.js":19}],19:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":35,"../utils/Utils.js":36,"./Attachment.js":6,"./Model.js":19}],21:[function(require,module,exports){
'use strict';
...
},{"../errors/JmapError":3,"../utils/Utils.js":36,"./Model.js":19}],23:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36,"./Model.js":19}],24:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":35,"../utils/Utils.js":36,"./Model.js":19}],25:[function(require,module,exports){
'use strict';
...
var AbstractConditionAction = function () {
  function AbstractConditionAction(filterRule) {
    _classCallCheck(this, AbstractConditionAction);
  ...
  _createClass(AbstractConditionAction, [{
    key: 'toJSONObject',
  ...
  return AbstractConditionAction;
}();

exports.default = AbstractConditionAction;
module.exports = exports['default'];
...
exports.default = filterRuleActions;

var _AbstractConditionAction = require('./AbstractConditionAction');

var _AbstractConditionAction2 = _interopRequireDefault(_AbstractConditionAction);
...
var MoveTo = function (_AbstractConditionAct) {
  _inherits(MoveTo, _AbstractConditionAct);

  function MoveTo() {
    _classCallCheck(this, MoveTo);

    return _possibleConstructorReturn(this, (MoveTo.__proto__ || Object.getPrototypeOf(MoveTo)).apply(this, arguments));
  }
  ...
  _createClass(MoveTo, [{
    ...
    key: '_validate',
    value: function _validate() {
      _Utils2.default.assertRequiredParameterIsPresent(this._mailboxId, '', 'Mailbox id is not set. Use mailboxId()');
    }
  }]);

  return MoveTo;
}(_AbstractConditionAction2.default);

function filterRuleActions(filterRule) {
  /**
...
},{"../../utils/Utils":36,"./AbstractConditionAction":25}],27:[function(require,module,exports){
'use strict';
...
exports.default = filterRuleConditions;

var _AbstractConditionAction = require('./AbstractConditionAction');

var _AbstractConditionAction2 = _interopRequireDefault(_AbstractConditionAction);

var _FilterRule = require('../FilterRule');
...
var AbstractCondition = function (_AbstractConditionAct) {
  _inherits(AbstractCondition, _AbstractConditionAct);

  function AbstractCondition() {
    _classCallCheck(this, AbstractCondition);

    return _possibleConstructorReturn(this, (AbstractCondition.__proto__ || Object.getPrototypeOf(AbstractCondition)).apply(this, arguments));
  }

  _createClass(AbstractCondition, [{
    key: '_init',
    value: function _init(field) {
      this._field = field;
    ...
    key: 'comparator',
    value: function comparator(val) {
      if (!_Utils2.default.objectValuesIncludes(_FilterRule2.default.Comparator, val)) {
        throw new Error('From#comparator(): ' + val + ' must be one of ' + _Utils2.default.objectValues(_FilterRule2.default.Comparator));
      }
    ...
    key: '_validate',
    value: function _validate() {
      _Utils2.default.assertRequiredParameterIsPresent(this._comparator, '', 'Comprator is not set. Use comparator()');
      _Utils2.default.assertRequiredParameterIsPresent(this._value, '', 'Value is not set. Use value()');
    }
  }]);
...
var From = function (_AbstractCondition) {
  _inherits(From, _AbstractCondition);

  function From() {
    _classCallCheck(this, From);

    return _possibleConstructorReturn(this, (From.__proto__ || Object.getPrototypeOf(From)).apply(this, arguments));
  }

  _createClass(From, [{
    key: '_init',
    value: function _init() {
      _get(From.prototype.__proto__ || Object.getPrototypeOf(From.prototype), '_init', this).call(this, 'from');
    }
  }]);
...
var To = function (_AbstractCondition2) {
  _inherits(To, _AbstractCondition2);

  function To() {
    _classCallCheck(this, To);

    return _possibleConstructorReturn(this, (To.__proto__ || Object.getPrototypeOf(To)).apply(this, arguments));
  }

  _createClass(To, [{
    key: '_init',
    value: function _init() {
      _get(To.prototype.__proto__ || Object.getPrototypeOf(To.prototype), '_init', this).call(this, 'to');
    }
  }]);
...
var Cc = function (_AbstractCondition3) {
  _inherits(Cc, _AbstractCondition3);
  ...
  _createClass(Cc, [{
    key: '_init',
    value: function _init() {
      _get(Cc.prototype.__proto__ || Object.getPrototypeOf(Cc.prototype), '_init', this).call(this, 'cc');
    }
  }]);
...
var Recipient = function (_AbstractCondition4) {
  _inherits(Recipient, _AbstractCondition4);
  ...
  _createClass(Recipient, [{
    key: '_init',
    value: function _init() {
      _get(Recipient.prototype.__proto__ || Object.getPrototypeOf(Recipient.prototype), '_init', this).call(this, 'recipient');
    }
  }]);
...
var Subject = function (_AbstractCondition5) {
  _inherits(Subject, _AbstractCondition5);
  ...
  _createClass(Subject, [{
    key: '_init',
    value: function _init() {
      _get(Subject.prototype.__proto__ || Object.getPrototypeOf(Subject.prototype), '_init', this).call(this, 'subject');
    }
  }]);
...
function filterRuleConditions(filterRule) {
  /**
...
},{"../../utils/Utils":36,"../FilterRule":13,"./AbstractConditionAction":25}],28:[function(require,module,exports){
'use strict';
...
},{"./PromiseProvider.js":29}],29:[function(require,module,exports){
'use strict';
...
},{"./PromiseProvider.js":29,"q":"q"}],31:[function(require,module,exports){
'use strict';
...
},{"../errors/TransportError":4,"./Transport.js":33}],32:[function(require,module,exports){
'use strict';
...
},{"../errors/TransportError":4,"../utils/Constants":34,"./Transport":33,"request":"request"}],33:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":36}],36:[function(require,module,exports){
'use strict';
...
var Utils = function () {
  ...
  _createClass(Utils, null, [{
    ...
    key: 'objectValues',
    value: function objectValues(object) {
      return Object.keys(object).map(function (key) {
        return object[key];
      });
    }
  }, {
    key: 'objectValuesIncludes',
    value: function objectValuesIncludes(object, value) {
...
},{"./Constants":34}],37:[function(require,module,exports){
/**
...
},{"./lib/bytesToUuid":37,"./lib/rng":38}]},{},[1])(1)
});
