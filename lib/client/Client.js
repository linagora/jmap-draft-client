...
export default class Client {
   ...
   * @return {Client} This Client instance.
   */
  withCustomMailboxRoles(roles = []) {
    roles.forEach(role => {
      MailboxRole[role.toLocaleUpperCase('en-US')] = new MailboxRole(role);
    });
   ...
   * @return {Client} This Client instance.
   */
  withJmapVersionHeader(include = true) {
   ...
   */
  saveAsDraft(message, drafts) {
    return this._createMessage(message, MailboxRole.DRAFTS, drafts);
  }
